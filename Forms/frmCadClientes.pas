...
begin
    ...
    begin
        Application.MessageBox('Atenção você está alterando o campo nome desse registro','Cadastro!', MB_OK + MB_ICONWARNING);

        if Application.MessageBox('Deseja prosseguir com a alteração?','Correção de campos.',MB_YESNOCANCEL + MB_ICONQUESTION) = mrYes then
        begin
            try

            if edtNome.Text = '' then
            begin
               Application.MessageBox('Atenção o campo ficou em branco','Verifique!', MB_OK + MB_ICONWARNING);
            end
            ...
            Application.MessageBox('Campo nome atualizado com sucesso!','Alteração!', MB_OK + MB_ICONINFORMATION);
            ...
            begin
              Application.MessageBox('Operação não realizada verifique!','Alteração!', MB_OK + MB_ICONINFORMATION);
            end;
    ...
    begin
        Application.MessageBox('Atenção você está alterando o campo telefone desse registro','Cadastro!', MB_OK + MB_ICONWARNING);
        ...
        begin
            ...
            Application.MessageBox('Campo telefone atualizado com sucesso!','Alteração!', MB_OK + MB_ICONINFORMATION);
    ...
    begin
        Application.MessageBox('Atenção você está alterando o campo logradouro desse registro','Cadastro!', MB_OK + MB_ICONWARNING);
        ...
        begin
            ...
            Application.MessageBox('Campo logradouro atualizado com sucesso!','Alteração!', MB_OK + MB_ICONINFORMATION);
    ...
    begin
        Application.MessageBox('Atenção você está alterando o campo sexo desse registro','Cadastro!', MB_OK + MB_ICONWARNING);
        ...
        begin
            ...
            Application.MessageBox('Campo sexo atualizado com sucesso!','Alteração!', MB_OK + MB_ICONINFORMATION);
...
begin
    ...
    begin
      Application.MessageBox('Id não encontrado, ou não foi selecionado nenhum registro, verifique!','Alteração!', MB_OK + MB_ICONINFORMATION);
    end
    else
    begin
      try
      ...
      Application.MessageBox('Registro deltado com sucesso!','Exclusão!', MB_OK + MB_ICONINFORMATION);
